...
frameDatos=ttk.Frame(frame1, padding="20 5 273 5")
...
#BOTONES
Button(frameDatos, text="Guardar", command=guardar, background='SpringGreen3', foreground='white',activebackground='SpringGreen4',font=("arial",11)).grid(column=2, row=9, sticky=(W), padx=10, pady=5)
Button(frameDatos, text="Cancelar", command=cancelar, background='firebrick3', foreground='white',activebackground='firebrick4',font=("arial",11)).grid(column=3, row=9, sticky=(W), padx=10, pady=5)
...
tv = ttk.Treeview(frameTabla, columns=("nombre","aPaterno", "aMaterno", "correo", "movil", "dedicacion", "estado", "lee", "musica", "videojuegos"))
